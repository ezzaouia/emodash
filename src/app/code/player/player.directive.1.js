...
export default module('player', []).directive('player', function (ControllerUtils, $log) {
    /**
    ...
    var volumeSliderEvents = function (player) {
        return {
            ...
            mouseleave: function () {
                d3.select(this).style('cursor', 'default');
                d3
                    .selectAll('.vc-slider-track-cursor,.vc-slider-track,.vc-slider-track-progress')
                    .style('stroke-width', 3);
    ...
    function PlayerController(
        ...
        this.timeDurationFilter = this.timeDurationFilter = function (streamTime) {
    ...
    PlayerController.prototype._initialLayout = function () {
        ...
        var volumeControlGroup = d3
            ...
            .append('g')
            .classed('g-player', true)
            .attr('transform', 'translate(' + 0 + ', ' + (PLAYER_CONTROLS_HEIGHT / 2 + 2) + ')');
                    ...
                    case 'stackedArea':
                        ...
                        renderedDatasetsSelection[d3Key]
                            ...
                            .on('mouseenter', function (d /*, i*/) {
                                ...
                                var texture = _.get(
                                    player,
                                    'colorsTexturesMap' + '.' + d3.color(currentColor) + '.' + 't',
                                );
